...
%
We know this is an issue in practice, and not just for us, because the specification of one-at-a-time membership changes for Raft that we adapted had two such issues which, with the default TLC options, would have taken on the order of hours to manifest at runtime.
%
